...
ALTER TABLE TB_PRODUTO
ADD COLUMN Cbarra varchar(50) NOT NULL;

select * from tb_cliente
delete from tb_cliente

UPDATE TB_CLIENTE
SET NOME = 'nebulinha',EMAIL = 'nebula@gmail.com', TEL = 2, ENDERECO = 'End', NUMERO = 22, CIDADE = 'mooca', ESTADO = 'SP' WHERE CPF = 120120120;

insert into tb_cliente values (nextval('sq_cliente'), 'Nebula', 120120120,2,'End',22,'mooca','SP','nebulinha@gmail.com');
